...
def lambda_handler(event, context):
    ...
    #PROD JAR
    jar_with_dependencies = "s3://.../amazon-review-0.0.1-jar-with-dependencies.jar"
    s3_config_bucket = "cert-analytics"
    s3_config_key = "marketing-trendline-config/pipeline_config.json"

    stream_steps = [
        {
            "Name": "01. STEP - [Stream]Preprocess amazon review Data",
            "HadoopJarStep": {
                "Args": [
                    "spark-submit",
                    "--deploy-mode", "cluster",
                    "--class", "com.jetw.di.controller.ReviewDataController",
